...
parser.add_argument("--mask_scale_ratio", type=float, default=0.8)
parser.add_argument("--mask_darker_ratio", type=float, default=0.2)
parser.add_argument("--mask_tsp", type=float, default=0.2)
